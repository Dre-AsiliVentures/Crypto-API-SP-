...
for coin in keywords:
    #start_symbol_ticker_socket()is in Threaded SocketManager
...
async def get_headlines():
    ...
    start = timer()
    print("Getting Crypto headlines in Process")
